...
export async function getSafeWebAuthnSignerFactoryContractInstance(
  ...
  switch (safeVersion) {
    ...
    default:
      const safeWebAuthnSignerFactoryContractInstance1 =
        new SafeWebAuthnSignerFactoryContract_v0_2_1(
          chainId,
          safeProvider,
          safeVersion,
      ...
      await safeWebAuthnSignerFactoryContractInstance1.init()

      return safeWebAuthnSignerFactoryContractInstance1
...
export async function getSafeWebAuthnSharedSignerContractInstance(
  ...
  switch (safeVersion) {
    ...
    default:
      const safeWebAuthnSharedSignerContractInstance1 = new SafeWebAuthnSharedSignerContract_v0_2_1(
        chainId,
        safeProvider,
        safeVersion,
        contractAddress,
      ...
      await safeWebAuthnSharedSignerContractInstance1.init()

      return safeWebAuthnSharedSignerContractInstance1
